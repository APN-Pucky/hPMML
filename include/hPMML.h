...
/**
 * hPMML version
 * Stores which version of the hPMML library is used.
 */
extern const std::string version;

/**
 * @class Exception
 * @brief Base class for all exceptions generated by hPMML.
 */
...
class Model {
 public:
  ...
  /**
   * @brief Constructs a hpmml::Model instance representing the PMML model
   * stored at *model_filepath*.
   *
   * <p>
   * It triggers the *model load* process: the XML elements are visited and the
   * corresponding internal hPMML objects are built.<br>
   *
   ...
   * Creating hpmml::Model instances from incorrect PMML files may result in
   * undefined behavior.<br>
   *
   * hpmml::ParsingException will be thrown in case *model_path* does not
   * exists.<br>
   *
   ...
   *
   * @throws hpmml::ParsingException
   * @throws hpmml::InvalidValueException
   * @throws hpmml::MissingValueException
   *
   *
   * <br><p><b>Examples</b></p>
   * @code{.cpp}
   ...
   * @endcode
   * @code{.cpp}
   * hpmml::Model model("AuditRandomForest.zip", true);
   * @endcode
   */
   ...
   * @param sample hash map where the keys are strings representing feature
   * names and the values are strings representing features values.
   * @return An instance of hpmml::Prediction
   *
   * @throws hpmml::InvalidValueException
   * @throws hpmml::MissingValueException
   * @throws hpmml::MathException
   *
   *
   * <br><p><b>Examples</b></p>
   * @code{.cpp}
   ...
   * optimization. Thus, hpmml::Model::predict achieves a significant speedup
   * compared to hpmml::Model::score.<br>
   * </p>
   *
   *
   * @param sample hash map where the keys are strings representing feature
